  ...
  <div class="register">
    ...
    <form class="app-form register-form" @submit.prevent="submitHandler()">
      <div class="app-form__input">
        ...
        />
        <span v-if="$v.email.$dirty && !$v.email.required">Email is empty</span>
      ...
      <div class="app-form__input">
        <input
          ...
          :class="{
            invalid:
              ...
              ($v.password.$dirty && !$v.email.minLength),
          }"
        />
        ...
        <span v-if="$v.password.$dirty && !$v.password.minLength"
          >Password dont be less than 6 symbols, now is
      ...
      <div class="app-form__input">
        <input
          ...
          :class="{
            invalid:
              ...
              ($v.dateOfBirth.$dirty && !$v.dateOfBirth.minLength),
          }"
        ...
        />
        <span v-if="$v.dateOfBirth.$dirty && !$v.dateOfBirth.required"
          >Date of birth field is empty</span
        >
        <span v-if="$v.dateOfBirth.$dirty && !$v.dateOfBirth.minLength"
          >Date of birth dont be less than 6 symbols, format is -
          01.01.1996</span
        >
      </div>
      <div class="app-form__input">
        ...
        <span v-if="$v.gender.$dirty && !$v.gender.required"
      ...
      <div class="app-form__input">
        ...
        />
        <span v-if="$v.city.$dirty && !$v.city.required"
          >City field is empty</span
        >
      </div>
      <button class="app-button" type="submit">Submit</button>
      <router-link class="app-link register-form__link" to="/login"
        >If you have account - login</router-link
      >
    </form>
  </div>
</template>
